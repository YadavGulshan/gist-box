...
function formatBytes(props) {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      if (props.bytes == 0) return [2 /*return*/, "0 bytes"];
      k = 1024;
      dm = props.decimals < 0 ? 0 : props.decimals;
      sizes = ["Bytes", "KB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"];
      i = Math.floor(Math.log(props.bytes) / Math.log(k));
      return [
        2 /*return*/,
...
function main() {
  return __awaiter(this, void 0, void 0, function () {
    var arr, isPrivate, userDataRaw, userData;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          arr = [];
          isPrivate = considerPrivate === "true";
          return [4 /*yield*/, octokit.users.getAuthenticated()];
        case 1:
          userDataRaw = _a.sent();
          userData = userDataRaw.data;
